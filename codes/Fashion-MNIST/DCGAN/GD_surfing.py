...
if dim == 5:
  schedule = np.array(np.round(grid/sum(grid)*618),dtype=int)
  stepsize = 0.01
elif dim == 10:
  schedule = np.array(np.round(grid/sum(grid)*4560),dtype=int)
  stepsize = 0.01
elif dim == 20:
  schedule = np.array(np.round(grid/sum(grid)*18937),dtype=int)
  stepsize = 0.001
