...
class WGAN(object):
    ...
    def __init__(self, sess, epoch, batch_size, z_dim, dataset_name, checkpoint_dir, result_dir, log_dir):
        ...
        if dataset_name == 'mnist' or dataset_name == 'fashion-mnist':
            ...
            # load mnist
            data_X, self.data_y = load_mnist(self.dataset_name)
            self.data_X = data_X[10000:]
            self.test_data = data_X[:10000]
    ...
    def build_model(self):
        ...
        if self.z_dim == 2:
            self.PMLR = plot_utils.Plot_Manifold_Learning_Result(self.result_dir, 20, 20, 28, 28, 1.0, 1.0) #change to 1
